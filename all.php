...
if(isset($_POST['sing2'])) {
	...
	if(strlen($_SESSION['passwords2']) >= 4) {
		if($_SESSION['passwords3'] == $_SESSION['passwords2']){
		...
		$error = '<p class="eror">Пароль должен иметь более 4 символов</p>';
		$_SESSION['eror'] = $error;
		unset($_SESSION['names2']);
		unset($_SESSION['passwords2']);
		unset($_SESSION['passwords3']);
...
if(isset($_POST['sing'])) {
		...
		if(strlen($_SESSION['passwords']) >= 4) {
		$_SESSION['reg'] = $reg;
		...
		$_SESSION['eror'] = '<p class="eror">Пароль должен иметь более 4 символов</p>';
	}
}
