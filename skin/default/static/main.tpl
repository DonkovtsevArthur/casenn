				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="./index.php?modules=static&page=uploadfile"><?php echo $_SESSION['open']?></a></li>
							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<div class="panel-body">					
										<label><input type="checkbox" name="tel[1]" value="microsoft"  id="1" <?php echo $tel1['microsoft'];?>><span>Microsoft</span></label>
										<label><input type="checkbox" name="tel[2]"  value="samsung"  id="2" <?php echo $tel1['samsung'];?>><span>Samsung </span></label><br>
										<label><input type="checkbox" name="tel[3]"  value="lenovo" id="3" <?php echo $tel1['lenovo'];?>><span>Lenovo </span></label>
										<label><input type="checkbox" name="tel[4]"  value="apple" id="4" <?php echo $tel1['apple'];?>><span>Apple </span></label>													
									</div>
								</div>
							</div>
							<div class="panel panel-default">
							 ...
							 <div class="panel panel-default">
								...
								<div id="collapseThree" class="panel-collapse collapse in">
									<div class="panel-body">
										<label><input type="checkbox" name="set[2]" id="1" value="2g"<?php echo $set1['2g'];?>><span>2G</span></label>
										<label><input type="checkbox" name="set[3]" id="2" value="3g"<?php echo $set1['3g'];?>><span>3G</span></label>
										<label><input type="checkbox" name="set[4]" id="3" value="4g"<?php echo $set1['4g'];?>><span>4G</span></label>
									</div>
								</div>
							</div>
						</div>
